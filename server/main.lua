...
RegisterServerEvent('rs_guncrafting:CraftingSuccess')
AddEventHandler('rs_guncrafting:CraftingSuccess', function(CraftItem)
    local src = source
...
-- Fail server event
RegisterServerEvent('rs_guncrafting:CraftingFailed')
AddEventHandler('rs_guncrafting:CraftingFailed', function(CraftItem)
    local src = source
    local xPlayer = ESX.GetPlayerFromId(src)
    local item = Crafting.Items[CraftItem]
...
ESX.RegisterServerCallback('rs_guncrafting:GetSkillLevel', function(source, cb)
...
ESX.RegisterServerCallback('rs_guncrafting:HasTheItems', function(source, cb, CraftItem)
