...
RegisterNUICallback('CraftingSuccess', function()
    ...
    TriggerServerEvent("rs_guncrafting:CraftingSuccess", CurrentCraft)
end)
...
RegisterNUICallback('CraftingFailed', function()
    ...
    ClearPedTasks(GetPlayerPed(-1))
    FreezeEntityPosition(GetPlayerPed(-1),false)
    TriggerServerEvent("rs_guncrafting:CraftingFailed", CurrentCraft)
end)

function OpenCraftMenu()
    local elements = {}
    ESX.TriggerServerCallback('rs_guncrafting:GetSkillLevel', function(level)
        ...
        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'crafting_actions', {
            ...
            ESX.TriggerServerCallback('rs_guncrafting:HasTheItems', function(result)
                if result then
                    ...
                    ESX.ShowNotification("~r~Not Enough Materials")
                end
            end, CurrentCraft)
